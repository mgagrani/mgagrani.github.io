...
I am a staff research scientist at [Qualcomm AI research](https://www.qualcomm.com/research/artificial-intelligence/ai-research). My research currently focuses on the efficiency of Large Language Models (LLMs), specifically developing cutting edge solutions for edge inference. Key areas of my recent research include:

- **Speculative Decoding (SPD)** - Pioneered application of SPD to multimodal models [Spotlight paper CVPR workshop 2024](https://arxiv.org/pdf/2404.08856), developed [Tree based SPD](https://arxiv.org/pdf/2402.14160), [Vocabulary trimming for efficient drafting](https://arxiv.org/pdf/2506.22694)
